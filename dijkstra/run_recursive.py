...
if __name__ == '__main__':
    ...
    for seed in seeding.generate_seed(g1_seed_file,g2_seed_file):
        ...
        start = time.time()
        a, b, pairs = recalignment.local_align3(graph1, graph2, seeding.get_aligned_seed(zip(*seed),graph1, graph2), sims, ec_mode, ed, e1, delta, alpha, seednum, debug=args.debugval)    
