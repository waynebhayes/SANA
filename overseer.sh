...
do
	...
	sed 's/\.out\.align/.stdout/' $OUTDIR/dir$i/jobs-done.txt | fgrep -v -f - $OUTDIR/dir$i/jobs.txt | parallel_delay networks/$NAME-shadow$i/autogenerated # wait until that directory is created before parallel'ing
    done
