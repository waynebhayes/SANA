...
./sana.multi -t 0 -mode shadow -fshadow regression-tests/shadow/start/yeastStartShadow.txt
...
./sana.multi -t 0 -mode shadow -fshadow regression-tests/shadow/next/yeastNextShadow.txt
...
./sana.multi -t 0 -mode shadow -fshadow regression-tests/shadow/startWithCols/yeastStartShadowWithCols.txt
#what some statistics should show:
#adjLists size: 1114
#color group sizes: 1090 23 1
#totalEdgeWeight: 39116

./sana.multi -t 0 -mode shadow -fshadow regression-tests/shadow/nextWithCols/yeastNextShadowWithCols.txt
