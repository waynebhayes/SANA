...
$SANA_EXE -fg1 networks/RNorvegicus.el -fg2 networks/SPombe.el -ec 1 -parallelTotalAlign 4 -parallelBatch 2 -parallelReportAll 1 -o regression-tests/PairwiseParallel/test-best
