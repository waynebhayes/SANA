...
nice -19 ./multi-pairwise.sh ./sana.multi '-s3 0 -ses 1' $ITERS $minutes '-parallel 4' $DIR networks/syeast[12]?/*.el
...
awkcel '{k=$1;expect=(0.5-k/10);if($3<expect)exit(1)}' $DIR/MNC.txt
