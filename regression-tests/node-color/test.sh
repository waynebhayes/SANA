...
"$SANA_EXE" -g1 yeast -g2 human -t 2 -s3 1 -fcolor1 $REG_DIR/yeast.col -fcolor2 $REG_DIR/human.col >$REG_DIR/y-h.col.stdout
...
"$SANA_EXE" -fg1 $REG_DIR/covid.el -fg2 $REG_DIR/covid.el -t 4 -s3 1 -fcolor1 $REG_DIR/covid.col -fcolor2 $REG_DIR/covid.col > $REG_DIR/covid.stdout
...
"$SANA_EXE" -fg1 $REG_DIR/covid.el -fg2 $REG_DIR/covid.el -t 0.3 -s3 1 -lock-same-names > $REG_DIR/lock.stdout
...
"$SANA_EXE" -fg1 $REG_DIR/colorTest1.el -fcolor1 $REG_DIR/colorTest1.col -fg2 $REG_DIR/colorTest2.el -fcolor2 $REG_DIR/colorTest2.col -s3 1 -t 2 > $REG_DIR/colorTest.stdout
...
"$SANA_EXE" -fg1 $REG_DIR/colorTest1.el -fg2 $REG_DIR/colorTest2.el -lock $REG_DIR/lockTest.lock -s3 1 -t 2 > $REG_DIR/colorTest2.stdout
