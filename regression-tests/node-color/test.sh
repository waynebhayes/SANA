...
(
    ...
    echo "echo The following error is expected >&2; '$SANA_EXE' -g1 yeast -g2 human -t 2 -s3 1 -fcolor1 $REG_DIR/yeast.col -fcolor2 $REG_DIR/human.col -o $REG_DIR/y-h.col >$REG_DIR/y-h.col.stdout 2>&1 && exit 1"
