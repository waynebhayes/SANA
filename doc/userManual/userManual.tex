...
%opening
\title{SANA: {\it Simulated Annealing Network Aligner}: Documentation}
\date{June 30, 2016}
\author{Contributors: Nil Mamano, Evan Palmer, Trenton Coleman}
...
\begin{quote}
{\bf NOTE:} The last substantial change to this document was on {\bf June 30, 2016};
although most of it is still correct, SANA has seen substantial changes / updates / improvements since then.
Some of them are documented in the README.md in the SANA repo at https://github.com/waynebhayes/SANA, and some
can be found in the SANA tutorial (DOI: 10.1007/978-1-4939-9873-9\_18, available also in this repo).

 - Wayne B. Hayes, August 2022.
\end{quote}
