...
./$SANA_EXE.multi -t 0 -mode shadow -fshadow $OUTDIR/dir0/fshadow.txt > $OUTDIR/dir0/fshadow.stdout 2>$OUTDIR/dir0/fshadow.stderr
...
do
    ...
    ./$SANA_EXE.multi -t 0 -mode shadow -fshadow $OUTDIR/dir$i1/fshadow.txt > $OUTDIR/dir$i1/fshadow.stdout 2> $OUTDIR/dir$i1/fshadow.stderr || die "$OUTDIR/dir$i1/$NAME-shadow$i1.gw network creation failed"
