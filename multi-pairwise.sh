...
./$SANA_EXE.multi -t 0 -mode shadow -fshadow $OUTDIR/dir0/fshadow.txt
...
do
    ...
    ./$SANA_EXE.multi -t 0 -mode shadow -fshadow $OUTDIR/dir$i1/fshadow.txt || die "$OUTDIR/dir$i1/$NAME-shadow$i1.gw network creation failed"
