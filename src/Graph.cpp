...
void Graph::serializeGraph(Graph& G, string outputName, bool bipartite, bool locked)
{
    ...
    string sentinel = "autogenerated/serialized/" + outputName + ".lock";
    ...
    if (fd != -1)
    {
        ...
        string outName = "autogenerated/serialized/" + outputName + (bipartite ? "_bipartite" : "_UntypedNodes")
...
{
    createFolder(autogenFilesFolder() + "serialized/");
    string sentinel = "autogenerated/serialized/" + name + ".lock";
    int fd = open(sentinel.c_str(), O_RDWR | O_EXCL | O_CREAT, 744);
    ...
    if (fd != -1)
    {
        ...
        string outName = "autogenerated/serialized/" + name + "_NodeNameToIndexMap" + ".bin";
...
void Graph::loadGraphFromBinary(Graph& g, string graphName, string lockFile, bool bipartite, bool lockedSameName)
{
    ...
    ifstream ifs("autogenerated/serialized/" + graphName + (bipartite ? "_bipartite" : "_UntypedNodes")
