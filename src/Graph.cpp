...
void Graph::serializeGraph(Graph& G, string outputName, bool bipartite, bool locked)
{
    ...
    if (fd != -1)
    {
        ...
        string outName = "networks/" + outputName + "/autogenerated/" + outputName + (bipartite ? "_bipartite" : "_UntypedNodes")
...
void Graph::loadGraphFromBinary(Graph& g, string graphName, string lockFile, bool bipartite, bool lockedSameName)
{
    ...
    ifstream ifs("networks/" + graphName + "/autogenerated/" + graphName + (bipartite ? "_bipartite" : "_UntypedNodes")
