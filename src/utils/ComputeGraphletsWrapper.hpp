...
static void saveGraphletsAsSigs(const Graph& G, uint maxGraphletSize, const string& outFile);

private:
static bool newerGraphAvailable(const char* graphDir, const char* binaryDir);
