...
void OptNetAlignWrapper::loadDefaultParameters() {
	parameters = "--total --s3 --nthreads 24 --cxrate 0.05 --cxswappb 0.75 --mutrate 0.05 --mutswappb 0.0001 --oneobjrate 0.75 --dynparams --popsize 2000 --generations 1000000000 --hillclimbiters 10000 --timelimit 1 --finalstats";
}
