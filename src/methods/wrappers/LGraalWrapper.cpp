...
LGraalWrapper::LGraalWrapper(Graph* G1, Graph* G2, double alpha, uint iterlimit, uint timelimit):
    ...
    g1NetworkFile = "tmp/lgraaltmp1_"+g1Name+"_"+intToString(randInt(0, 999999))+".gw";
    g2NetworkFile = "tmp/lgraaltmp2_"+g2Name+"_"+intToString(randInt(0, 999999))+".gw";
    ...
    lgraalOutputFile = "tmp/"+G1->getName()+"_"+G2->getName()+"_"+intToString(randInt(0, 999999))+"_lgraalOutput.txt";
}
