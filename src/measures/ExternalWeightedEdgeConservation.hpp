...
private:
    ...
    int getColIndex(std::string n1, std::string n2); //returns the index of an edge between 2 nodes; -1 if not in col
    int getRowIndex(std::string n1, std::string n2); //returns the index of an edge between 2 nodes; -1 if not in row
