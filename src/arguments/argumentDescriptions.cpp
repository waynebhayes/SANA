...
vector<array<string, 6>> argumentDescriptions = {
	...
	{ "-pathmap2", "integer", "", "Path Map G2", "Maps a path in G2 to an edge in G1, as if the path were a single edge in G1.", "1" },
	...
	{ "-tinitial", "double", "auto", "Initial Temperature", "Starting temperature of the simulated annealing. \"auto\" means calculate optimal starting temperature (requires extra CPU time).", "1" },
	{ "-tdecay", "double", "autoi", "Rate of Decay", "Exponential decay parameter of the temperature schedule. \"auto\" means calculate optimal starting temperature (requires extra CPU time).", "1" },
	...
	{ "-goweights", "vector", "1 1", "Weight and Measure of GO Measures", "Specifies the maximum GOk measure and the weight of each one.", "1" },
