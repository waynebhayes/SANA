...
void initGraphs(Graph& G1, Graph& G2, ArgumentParser& args) {
    ...
    if (fg1 == "")
    {
        ...
        + (lockFile.size() > 1 ? "_Locked" : "_Unlocked") + (weighted ? "_Weighted" : "_Unweighted") + ".bin";
    ...
    if (p1 == 1 && p2 == 1){
        ...
        if(fg1 == ""){
            ...
            G1 = Graph::loadGraphFromPath(fg1, g1Name, args.bools["-nodes-have-types"]);
        ...
        if(fg2 == ""){
            ...
            G2 = Graph::loadGraphFromPath(fg2, g2Name, args.bools["-nodes-have-types"]);
