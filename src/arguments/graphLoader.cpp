...
// By default, USE_CACHED_FILES is 0 and SANA does not cache files. Change USE_CACHED_FILES at your own risk.
    if (fg1 == "")
    {
        ...
        string bin = "networks/" + g1Name + "/autogenerated/" + g1Name + (args.bools["-bipartite"] ? "_bipartite" : "_Unbipartite")
    ...
    if (fg2 == "")
    {
        ...
        string bin = "networks/" + g2Name + "/autogenerated/" + g2Name + (args.bools["-bipartite"] ? "_bipartite" : "_Unbipartite") 
        + (usingLocks ? "_Locked" : "_Unlocked") + (multi_pairwise ? "_Multi_pairwise" : "_Not_multi_pairwise") + ".bin";
