...
// By default, USE_CACHED_FILES is 0 and SANA does not cache files. Change USE_CACHED_FILES at your own risk.
    string g1LockDir = "autogenerated/serialized/" + g1Name + ".lock";
    string g2LockDir = "autogenerated/serialized/" + g2Name + ".lock";
    struct stat st;
...
// By default, USE_CACHED_FILES is 0 and SANA does not cache files. Change USE_CACHED_FILES at your own risk.
    if (fg1 == "")
    {
        ...
        string bin = "autogenerated/serialized/" + g1Name + (args.bools["-bipartite"] ? "_bipartite" : "_UntypedNodes")
    ...
    if (fg2 == "")
    {
        ...
        string bin = "autogenerated/serialized/" + g2Name + (args.bools["-bipartite"] ? "_bipartite" : "_UntypedNodes") 
        + (usingLocks ? "_Locked" : "_Unlocked") + (multi_pairwise ? "_Multi_pairwise" : "_Not_multi_pairwise") + ".bin";
