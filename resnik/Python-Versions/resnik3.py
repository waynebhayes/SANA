...
import sys
sys.path.append('/extra/wayne0/preserve/resnik/python/fastsemsim-code/fastsemsim/')
...
acDir = "/extra/wayne0/preserve/resnik/python/"
...
def initParser():
    ...
    parser.add_argument("-go", "--gene2go", default=acDir+"gene2go", type=str,
            help="path to gene2go file, default is "+acDir+"gene2go")
    ...
    parser.add_argument("-oc", "--ontology-root", default="BP-MF-CC", type=str, 
		    help="Ontology root, defaults to all (BP-MF-CC). Separate by '-'") 
...
if __name__ == "__main__":
    ...
    GENE_ONTOLOGY_FILE = "/extra/wayne0/preserve/resnik/python/go.obo"
    ...
    TAXON_CODES = {"AThaliana","CElegans","DMelanogaster","HSapiens", "MMusculus", "RNorvegicus",
                   "SCerevisiae","SPombe"}
    TAXON_FILES = {key : "/extra/wayne0/preserve/resnik/python/taxons/" + key + ".txt" 
