...
MEASURES_SRCS = 				 						\
	...
	src/measures/ConservedInteractionQuality.cpp	\
	...
	src/measures/SymmetricSubstructureScore.cpp         \
        ...
        src/measures/MultiSymmetricEdgeCoverage.cpp         \
	...
	src/measures/localMeasures/MultiSequence.cpp	    \
	src/measures/localMeasures/MultiLocalMeasure.cpp	\
        src/measures/localMeasures/MultiImportance.cpp      \
...
SRCS = $(UTILS_SRC) $(MEASURES_SRCS) $(METHODS_SRC) $(METHOD_WRAPERS_SRC) $(ARGUMENTS_SRC) $(MODES_SRC) $(OTHER_SRC)
