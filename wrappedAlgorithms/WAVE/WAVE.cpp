...
{	
	if(argc-1 != 4)
	{
		cout << "Usage: " << argv[0] << " [input-network1] [input-network2] [input-similarity] [output-alignment]\n";
		cout << "input-network1 and input-network2 have to be in lst format\n";
		return 1;
	}
	time_t now_time = time(NULL);
	
	int noNodes1 = getnodes(argv[1]);
	int noNodes2 = getnodes(argv[2]);
	int M = (noNodes1>noNodes2) ? noNodes1 : noNodes2;
