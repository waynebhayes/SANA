...
#ifndef OUTPUTSTATAMC_H_
#define OUTPUTSTATAMC_H_
...
class OutputStatAmc : public Output<GR, BGR>
{
public:
...
public:
  OutputStatAmc(const MatchingGraphType& matchingGraph,
...
template<typename GR, typename BGR>
inline void OutputStatAmc<GR, BGR>::write(const BpMatchingMapType& matchingMap,
                                          ...
                                          std::ostream& out) const
{
  ...
  double gap = (_upperBound - _score) / _score * 100;
