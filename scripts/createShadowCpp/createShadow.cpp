...
namespace shadow_graph {
    class Graph {
        ...
        void writeBin(Graph& G, std::string& fileName)
        {
            ...
            createFolder("autogenerated/serialized/");
            std::ofstream ofs("autogenerated/serialized/" + fileName + "_Shadow.bin", std::ofstream::binary | std::ofstream::out);
            if (ofs.is_open())
            {
        ...
        {
            std::ifstream ifs("autogenerated/serialized/" + fileName + "_Shadow.bin", std::ifstream::binary | std::ifstream::in);
            if (ifs.is_open()) {
        ...
        public:
            ...
            void load(const std::string& filename) {
                ...
                std::string binName = "autogenerated/serialized/" + fileName + "_Shadow.bin";
