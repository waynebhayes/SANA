...
namespace shadow_graph {
    class Graph {
        ...
        void writeBin(Graph& G, std::string& fileName)
        {
            ...
            createFolder(Graph::serializedFilesFolder());
            std::ofstream ofs(Graph::serializedFilesFolder() + fileName + "_Shadow.bin", std::ofstream::binary | std::ofstream::out);
            if (ofs.is_open())
            {
        ...
        {
            std::ifstream ifs(Graph::serializedFilesFolder() + fileName + "_Shadow.bin", std::ifstream::binary | std::ifstream::in);
            if (ifs.is_open()) {
        ...
        public:
            ...
            void load(const std::string& filename) {
                ...
                std::string binName = Graph::serializedFilesFolder() + fileName + "_Shadow.bin";
